...
class TaskRepository:
    ...
    def _task_to_dict(self, task: Task) -> dict:
        ...
        task_dict["created_at"] = task.created_at.isoformat() if isinstance(task.created_at, datetime) else task.created_at
        task_dict["updated_at"] = task.updated_at.isoformat() if isinstance(task.updated_at, datetime) else task.updated_at
        return task_dict
